...
func TestParser(t *testing.T) {
	tt := []struct {
		...
		{"objfile.o", []string{"Type", "Import", "Function", "Element", "sectionID(12)", "Code", "Data", "Custom", "Custom", "Custom", "Custom", "Custom", "Custom", "Custom", "Custom", "Custom", "Custom", "Custom", "Custom"}},
	}
